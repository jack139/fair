...
class handler:        
	def POST(self, version='v2'):
		...
		param = web.input(app_id='',session='',addr_id='',name='',tel='',addr='',title='',detail='',city='',loc='',sign='')

		if '' in (param.app_id, param.session, param.addr_id, param.name, param.tel, param.addr, param.sign):
